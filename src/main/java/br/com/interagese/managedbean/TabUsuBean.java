...
import br.com.interagese.Tabusu;
import br.com.interagese.conexao.Conectar;
                ...
                */
                ...
                while(rs.next()){
                    ...
                    while(rs2.next()){
                        ...
                        String label4 = rs2.getString("DESCRICAO");
                        
                        DefaultMenuItem item = new DefaultMenuItem(label4);
