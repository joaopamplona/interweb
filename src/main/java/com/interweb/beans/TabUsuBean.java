...
public class TabUsuBean {
    ...
    public String LogarUsuario(Tabusu tabusu) {
        ...
        try {
            ...
            if(resultTabUsu.isEmpty()){
                FacesContext.getCurrentInstance().addMessage("myform:frmlogin", new FacesMessage("Usuário ou senha incorretos"));
            } else {
                for (Tabusu usuario : resultTabUsu) {
                    ...
                    if(resultTabsis.isEmpty()){
                        FacesContext.getCurrentInstance().addMessage("myform:frmlogin", new FacesMessage("Tabsis nao encontrada"));
                    } else {
                        ...
                        for (Tabsis sistema : resultTabsis) {
                            ...
                            if(resultMenuitem.isEmpty()){
                                FacesContext.getCurrentInstance().addMessage("myform:frmlogin", new FacesMessage("Este usuário não tem acesso a nenhum sistema "));
                            } else {
